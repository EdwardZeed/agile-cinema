...
public class CustomerInterface {
    ...
    public String checkTimeOut(){
        ...
        try {
            return TI.getInput().toLowerCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
